...
| Track | Good Neighbor Agents | Selected; sponsor determines final fit |

Good Neighbor explicitly targets groups, such as schools, libraries and local organizations. This app currently supports individual case review and a user-controlled handoff report. It does not implement a shared inbox, group permissions or demonstrated organizational use. The pitch must explain a credible group-helper workflow without claiming those features or adoption.
