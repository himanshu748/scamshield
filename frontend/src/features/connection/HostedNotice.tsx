...
function Notice() {
  ...
  return <aside className="hosted-notice" aria-label="ScamShield privacy and usage">
    <span>No sign-up needed</span>
    <details><summary>Privacy &amp; usage</summary>
      <p>Your cases are saved on the server and linked to this browser by a cookie. Clearing cookies loses access. Please use fictional or non-sensitive inputs.</p>
      <p>Daily AI allowance: 10 requests in this browser, 20 per network and 50 across ScamShield. Saved cases and approvals remain available when the daily AI allowance runs out.</p>
